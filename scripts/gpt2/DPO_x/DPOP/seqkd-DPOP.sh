...
# CKPT="${BASE_PATH}/results/gpt2/train/seqkd-DPOP/e20-bs8-lr0.0005-G1-N1-NN1-kd0.5-DPOP_lambda_50-label_smth_0.0-dpo_beta_0.1-kd_ratio_0.5/2024_03_13-00_15/28580"
...
SAVE_PATH="${BASE_PATH}/results/gpt2/train/seqkd-DPOP-fr_sch"
OPTS+=" --save ${SAVE_PATH}"
